==========================================================
Guided Instructions: Create Records for Miscellaneous Text
==========================================================

This page is applicable to text materials that are not formally published, which may include:

-   informal pamhlets (e.g., event programs or flyers)
-   text of speeches, drafts or manuscripts
...
For some text items, it *may* be appropriate to refer to other guidelines:

-   If the item is a handwritten letter (or similar), consult the guidelines for :doc: `correspondence </guides/correspondence>`
-   When you have several items that are regularly-occurring documentation (e.g., meeting minutes, financial or statistical reports, etc.), 
    the guidelines for :doc: `serials </guides/serials>` will keep records consistent and reduce work
-   For the text of an interview, see :doc: `oral histories </guides/interviews>`


**How to use these instructions:**

-   This page walks step-by-step through creating a record for an item with yes/no questions 
...
-   Information should generally based off what you can see on the item that you're describing, but for some collections there
    ...
    -   For example, if a question says "do you know when the text was written" the answer could be "yes" 
...
.. admonition:: Question
   ...
   **Does the item have an official title assigned by the author?**


+---------------------------------------------------------------+-------------------------------------------------------------------------------+
|Yes                                                            |No                                                                             |
+===============================================================+===============================================================================+
|-  Choose "Main Title" in the drop-down menu if it is not      |-  Create a title that briefly describes the item/content                      |
|   already marked                                              |-  Enclose the title in [square brackets] to show that it                      |
|-  Enter the official title in the text box using the same     |   was assigned by the editor and not the item's creator                       |
|   capitalization and punctuation as the author                |                                                                               |
|                                                               |                                                                               |
...
|                                                               |                                                                               |
|                                                               |       -   If it is important to the content, include names                    |
|                                                               |           (e.g., legal documents, financial records) and/or                   |
|                                                               |           dates (e.g., reports or financial records) when the                 |
|                                                               |           information is available                                            |
|                                                               |                                                                               |
|                                                               |   -   When adding dates to titles, it *may* be useful to not                  |
|                                                               |       put the dates at the start of the title for sorting                     |
|                                                               |       purposes                                                                |
|                                                               |   -   If there are multiple copies that have identical content                |
|                                                               |       the same title may be used with numerals designating #1,                |
|                                                               |       #2, etc.; if they are merely similar, add something to                  |
|                                                               |       note how they are different, e.g., Draft, Annotated,                    |
|                                                               |       etc.                                                                    |
|.. note::                                                      |   -   Here are some examples of general patterns for common                   |
|                                                               |       material types (adjust based on available info and                      |
...
+---------------------------------------------------------------+-------------------------------------------------------------------------------+
|-  `About the Congressional Black Caucus                       |-  `[Change of Membership Certificate for Lily Holmes]                         |
|   <https://texashistory.unt.edu/ark:/67531/metapth1790339/>`_ |   <https://texashistory.unt.edu/ark:/67531/metapth1252650/>`_                 |
|                                                               |                                                                               |
|-  `The Cause & Cure for Insecurity                            |-  `[Invoice for Brenners Park Hotel Charges, September 17, 1955]              |
|   <https://texashistory.unt.edu/ark:/67531/metapth1560571/>`_ |   <https://texashistory.unt.edu/ark:/67531/metapth1384280/>`_                 |
|                                                               |                                                                               |
...
.. admonition:: Question
   ...
   **Is there an author name on the item, or do you know who was primarily responsible for writing the text?**


+---------------------------------------------------------------+-----------------------------------------------------------+
|Yes                                                            |No                                                         |
+===============================================================+===========================================================+
|-  Enter the name of the author in the creator text box;       |Skip the creator field.  Use the "x" if there are          |
|   invert personal names (last, first)                         |placeholder values to clear the entire entry.              |
|-  Choose the type: Personal (specific individual)             |                                                           |
|   or Organization (company, club, etc.)                       |                                                           |
|-  Choose "Author" as the role in the second drop-down menu    |                                                           |
|   OR the role of the primary creator of the text, e.g.,       |                                                           |
|   "compiled by" (compiler) for data or lists                  |                                                           |
|                                                               |                                                           |
|.. note::                                                      |                                                           |
|                                                               |                                                           |
...
.. admonition:: Question
   ...
   **Is there another person or organization directly related to the item?**  For example:
   ...
   -    someone who currently owns the item, other than the partner institution
   -    a person or organization that printed a pamphlet, added illustrations, did typesetting, etc.
...
|-  If there are multiple contributors (e.g., an item           |                                                           |
...
.. admonition:: Question
   ...
   **Do you know when the item was made?**
...
|-  More complex dates that are common:                         |                                                           |
|                                                               |                                                           |
|   -   Approximate/circa dates: add a ~ at the end             |                                                           |
|   -   Tildes can also be used in an inclusive range for "ca.  |                                                           |
|       year-year": YYYY~/YYYY~                                 |                                                           |
|   -   Text compiled or written over a period of time (e.g.,   |                                                           |
|       a ledger containing records added over time, legal      |                                                           |
|       documents compiled over the course of proceedings): use |                                                           |
|       an inclusive range: YYYY/YYYY                           |                                                           |
|   -   A known *decade*: replace the last digit with "X"       |                                                           |
|   -   A text written at a point sometime within a known range:|                                                           |
|       use "one of a set" notation with periods for a range    |                                                           |
|       [YYYY-MM-DD..YYYY-MM-DD] (between first date and second |                                                           |
|       date, inclusive)                                        |                                                           |
|                                                               |                                                           |
|                                                               |                                                           |
|.. warning::                                                   |.. note::                                                  |
|                                                               |                                                           |
|   Dates must conform to the ISO Extended Date/Time Format     |   This will automatically display publicly as "Creation   |
|   (EDTF) standard; a warning will display on the right side of|   Date: Unknown"                                          |
...
.. admonition:: Question
   ...
   **Is there any written text on the item aside from numbers or names?**
...
|                                                               |   is names -- e.g., a list of attendees with no other info -- |
|                                                               |   choose "No Language"                                        |
+---------------------------------------------------------------+---------------------------------------------------------------+
|Examples of what these values might look like:                                                                                 |
+---------------------------------------------------------------+---------------------------------------------------------------+
...
Content Description
===================
-   The content description is required; it is based on looking at the item and describing the content of the text
...
-   The description should focus on what is in the text rather than context or assumptions about what might be happening
